...
--
-- Host: localhost:3306
-- Generation Time: Dec 25, 2024 at 04:33 PM
...
(30, 'Penyimpanan', 'Display', 5, 'Penyimpanan lebih penting dari Display\r\n'),
(31, 'Display', 'Memory', 1, 'Display lebih penting dari Memory'),
(32, 'Processor', 'Display', 9, 'Processor lebih penting dari Display'),
...
(35, 'Berat', 'Display', 0.2, 'Berat kurang penting dari display\r\n'),
(36, 'Display', 'Processor', 0.142857, 'Display lebih rendah penting dibandingkan Processor'),
...
(40, 'Penyimpanan', 'Display', 0.2, 'Penyimpanan kurang penting dibandingkan Display'),
(41, 'Display', 'Penyimpanan', 5, 'Display lebih penting dari Penyimpanan'),
...
(46, 'Display', 'Berat', 7, 'Display lebih penting dari Berat'),
(47, 'Processor', 'Penyimpanan', 0.2, 'Processor lebih penting dari Penyimpanan'),
(48, 'Memory', 'Display', 7, 'Memory lebih penting dari Display'),
...
(51, 'Display', 'Processor', 9, 'Display lebih penting dari Processor'),
...
(55, 'Berat', 'Display', 0.333333, 'Berat sedikit lebih penting dari Display'),
(56, 'Penyimpanan', 'Display', 3, 'Penyimpanan lebih penting dari Display'),
(57, 'Display', 'Processor', 3, 'asdawd asd awda sd a'),
(58, 'Processor', 'Penyimpanan', 5, 'asdawda sdasda wdasd '),
(59, 'Berat', 'Display', 2, 'asdawd asda wdas dawd'),
(60, 'Memory', 'Processor', 0.111111, 'asdawda sdawda sdawd asd'),
(61, 'Penyimpanan', 'Display', 7, 'Penyimpanan lebih penting dari Display'),
(62, 'Display', 'Penyimpanan', 0.111111, 'edit Test\r\n'),
(63, 'Display', 'Processor', 5, 'display lebih penting di  bandingkan processor'),
...
CREATE TABLE `laptop` (
  ...
  `display_laptop` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  ...
  `display_nilai` float NOT NULL DEFAULT '0',
  ...
  `normalized_display` float NOT NULL DEFAULT '0',
  ...
  `normalized_display_nilai` float NOT NULL DEFAULT '0',
...
INSERT INTO `laptop` (`laptop_id`, `nama_laptop`, `display_laptop`, `procesor_laptop`, `memori_laptop`, `penyimpanan_laptop`, `berat_laptop`, `profile`, `display`, `proc`, `memo`, `penyim`, `berat`, `total_bobot`, `display_nilai`, `proc_nilai`, `memo_nilai`, `penyim_nilai`, `berat_nilai`, `total_nilai`, `normalized_display`, `normalized_proc`, `normalized_memo`, `normalized_penyim`, `normalized_berat`, `total_normalize`, `normalized_display_nilai`, `normalized_proc_nilai`, `normalized_memo_nilai`, `normalized_penyim_nilai`, `normalized_berat_nilai`, `total_normalize_nilai`, `nilai_ranking`) VALUES
